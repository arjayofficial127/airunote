...
export const examsTable = pgTable('exams', {
  ...
  archivedByUserId: uuid('archived_by_user_id').references(() => usersTable.id, { onDelete: 'set null' }),
  createdAt: timestamp('created_at').notNull().defaultNow(),
  updatedAt: timestamp('updated_at').notNull().defaultNow(),
}, (table) => ({
...
export const examAttemptsTable = pgTable('exam_attempts', {
  ...
  questionTiming: jsonb('question_timing').notNull().default({}),
  ...
  previewedByUserId: uuid('previewed_by_user_id').references(() => usersTable.id, { onDelete: 'set null' }),
  previewedByEmail: varchar('previewed_by_email', { length: 255 }),
  previewedByRole: varchar('previewed_by_role', { length: 80 }),
  voidedAt: timestamp('voided_at'),
  voidedByUserId: uuid('voided_by_user_id').references(() => usersTable.id, { onDelete: 'set null' }),
